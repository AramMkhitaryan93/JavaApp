...
public class Bank {
    ...
    /**
     *  Crate a new Bank object with empty lists of users and accounts
     ...
     */
    public User addUsr(String firstName, String lastName, String pin) {
        // create a new User object and add iy to list
        User newUser = new User(firstName, lastName, pin, this);
        this.users.add(newUser);
        //crate a savings account for the user
        //accounts lists
